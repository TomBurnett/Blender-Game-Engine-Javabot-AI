...
/**
* VegetationObject Class
* 
* Holds name, position and scale information
* for a Vegetation Object
*
...
public class VegetationObject {
	...
	/**
	* Creates a Vegetation object with the parameters
	...
	*/
	public VegetationObject (String uniqueName, float x, float y, float scaleX, float scaleY) {
